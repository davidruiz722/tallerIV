...
//accedemos al modulo													//intermediario						
...
$http.post("http://localhost:8080/springtaller/productos",producto).success(function(){
...
$http.get("http://localhost:8080/springtaller/productos").success(function(productos){
...
<tr ng-repeat="producto in productos">
	...
	<td>  <button ng-click="updateProducto(producto)" class="btn waves-effect waves-light" type="submit" name="action">Editar
